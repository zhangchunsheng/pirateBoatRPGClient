(function(BTG) {
	...
	BTG.CharacterActionBind.prototype.update = function (dt) {
		//cc.log("BTG.CharacterActionBind.prototype.update");
		...
		//action callback
		if (pPlayer.m_owner.hasOwnProperty("m_aa_type") && pPlayer.m_owner.m_aa_type !== -1) {
		...
		if(this.pCharacter.m_curActionAA_type == BTG.CA_Stand) {
			this.pCharacter.updateStand();
		} else if(this.pCharacter.m_curActionAA_type == BTG.CA_Run) {
			this.pCharacter.updateRun();
		}
	}
