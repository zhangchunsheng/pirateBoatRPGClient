...
(function () {
    ...
    (function (exports, io, global) {
        ...
        Socket.prototype.handshake = function (fn) {
            ...
            var url = [
                'http' + (options.secure ? 's' : '') + ':/', options.host + ':' + options.port, options.resource, io.protocol, io.util.query(this.options.query, 't=' + +new Date)].join('/');
        ...
        Socket.prototype.disconnectSync = function () {
            ...
            var xhr = io.util.request();
            var uri = [
                'http' + (this.options.secure ? 's' : '') + ':/', this.options.host + ':' + this.options.port, this.options.resource, io.protocol, '', this.sessionid].join('/') + '/?disconnect=1';
